...
<form id="form2" action="<%=basePath%>emp/addEmployee" method="post">
...
<script type="text/javascript">
    ...
    //查询职位
	$.ajax({
		url:"<%=basePath%>pos/findJsonPosition",
		type:"get",
	...
	//查询角色
	$.ajax({
		url:"<%=basePath%>role/findJsonRole",
		type:"get",
		success:function (msg) {
			$(msg).each(function (index,item) {
				var input = "<input name='rid' type='checkbox' value='"+item.roleid+"'/>"+item.rolename;
				$("#role").append(input);
            })
        }
	})
