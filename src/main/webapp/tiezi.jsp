...
<body>
<form action="<%=basePath%>forumpost/addForumpost" method="post">
    标题：<input name="forumtitle" title="帖子标题" /> <br/>
    内容：<script name="forumcontent" id="editor" type="text/plain" style="width:1024px;height:500px;"></script><br/>
