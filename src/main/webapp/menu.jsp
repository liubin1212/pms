...
<body target="main">
	<table  width='99%' height="100%" border='0' cellspacing='0' cellpadding='0' >
        <tr><td style='padding-left:3px;padding-top:8px' valign='top' id="menuss">
			<c:forEach items="${list}" varStatus="index" var="list1">
				<dl class='bitem'>
					<dt onclick=showHide("items${index.count}_1")><b>${list1.name}</b></dt>
					<c:if test="${index.count == 1}">
						<dd style='display:block' class='sitem' id=items${index.count}_1>
							<ul class='sitemu' id=${index.index}>
								<c:forEach items="${list1.children}" var="sources">
            ...
            <li><a href='<%=basePath%>pro/findAllProject' target='main'>基本信息管理</a> </li>
            <li><a href='<%=basePath%>ana/findAllAnalysis' target='main'>需求分析管理</a> </li>
            <li><a href='<%=basePath%>module/findAllModule' target='main'>模块管理</a> </li>
            <li><a href='<%=basePath%>func/findAllFunction' target='main'>功能管理</a> </li>
            <li><a href='<%=basePath%>attach/findAllAttachment' target='main'>附件管理</a> </li>
            </ul>
            </dd>
            </dl>
            ...
            <dl class='bitem'><dt onclick=showHide('items2_1')><b>日常办公</b></dt><dd style='display:none' class='sitem' id=items2_1><ul class='sitemu' id=1>
                ...
                <li><a href='<%=basePath%>baoxiao/findAllBaoxiao' target='main'>我的报销</a> </li>
                <li><a href='tiezi.jsp' target='main'>发帖页面</a> </li>
            </ul></dd></dl>
            ...
            <li><a href='<%=basePath%>cust/findAllCustomer' target='main'>客户信息</a> </li>
            </ul></dd></dl>
            ...
            <li><a href='indexvalue-base.jsp' target='main'>对标信息管理</a></li>
