...
<script type="text/javascript">
	...
	<DIV>
		<form action="<%=basePath%>emp/login" method="post" id="form1">
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=regtxt title=请填写用户名 maxLength=16
														size=16 name="username" value="${username}" id=username></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>密&nbsp;
															码：</FONT></TD>
													<TD><INPUT class=regtxt title=请填写密码 type=password
														maxLength=16 size=16 name="password" value="${password}" id=pass></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>验证码：</FONT></TD>
													<TD><INPUT style="width: 68px; margin-top: 0px;vertical-align:middle;" class=regtxt title=请填写验证码 maxLength=50
														size=16 value="" name="valicode">
														<img style="vertical-align:middle;"  id="image" src="<%=basePath%>code/getCode?time=<%=new Date()%>" alt="">
													</TD>
												</TR>
												<TR>
													<TD colspan="2" align=middle width=81><FONT color=#ffffff><font color="red">${msg}</font></FONT></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
...
<script type="text/javascript">
	$("#image").click(function () {
		$(this).prop("src","<%=basePath%>code/getCode?time="+ new Date());
    })
	function login() {
		$("#form1").submit();
    }
