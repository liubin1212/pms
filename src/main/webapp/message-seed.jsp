...
<form id="form2" action="<%=basePath%>email/addEmail" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
	//请求收件人信息
	$.ajax({
		url:"<%=basePath%>emp/findExportIdEmployee",
		type:"get",
		success:function (msg) {
			$(msg).each(function (index,itmp) {
				var o = $("<option value='"+itmp.archives.email+"'>"+itmp.ename+"</option>");
				$("#Employee").append(o);
            });
        }
	});
